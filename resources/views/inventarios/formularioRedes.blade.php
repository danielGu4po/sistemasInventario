        ...
        <div class="row">
            <div class="col-3">
                <div class="form-group">
                    ...
                    <input type="text" name="inventarioModelo" id="inventarioModelo" class="form-control" placeholder="Ej. TP-Link DECO Mesh AC1200">
                </div>
            </div>
            <div class="col-3">
                <div class="form-group">
                    <label for="inventarioMarca" class="col-form-label">Marca:</label>
                    <input type="text" name="inventarioMarca" id="inventarioMarca" class="form-control" placeholder=" Ej. TP-LINK, Nanostation">
                </div>
            </div>
            <div class="col-3">
                <div class="form-group">
