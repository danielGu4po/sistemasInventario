                        ...
                        <div class="row g-0">
                            <div class="col-lg-6">
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <div class="text-center">
                                        <img src="{{asset('img/imagen1.png')}}" style="width: 185px;" alt="logo">
                                    </div>
                                    ...
                                    @csrf
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <input type="email" name="email" id="form2Example11" class="form-control" placeholder="Ingresar correo" required/>
                                        </div>
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <input type="password" name="password confirmation" id="form2Example22" class="form-control" required/>
                                        </div>
                            ...
                            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                                <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                                    <h4 class="mb-4">Servicios y Equipos TOPO S.A de C.V</h4>
                                    <p class="small mb-0">Más de 30 años de experiencia en la industria minera.</p>
                                </div>
                            </div>
                        </div>
                    </div>
