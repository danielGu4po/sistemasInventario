...
<body>
    <div class="container mt-3">
        ...
        <form id="verificacionForm" action="" method="POST">
            @csrf
            <style>
    ...
    <div class="col-6">
        ...
        <div class="form-group">
            <div class="form-check">
                ...
                <input class="form-check-input" type="checkbox" id="verificacionConcepto1" name="verificacionConcepto1">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto2">2. Clave de acceso para iniciar sesión en el equipo.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto2" name="verificacionConcepto2">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto3">3. Actualización de software de aplicación.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto3" name="verificacionConcepto3">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto4">4. Actualización de sistema operativo (Windows).</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto4" name="verificacionConcepto4">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto5">5.-Respaldo de Correos.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto5" name="verificacionConcepto5">
            </div>
        </div>
    </div>
    ...
    <div class="col-6">
        ...
        <div class="form-group">
            <div class="form-check">
                ...
                <input class="form-check-input" type="checkbox" id="verificacionConcepto20" name="verificacionConcepto20">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto21">21.Limpiador de pantalla.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto21" name="verificacionConcepto21">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto22">22.Alcohol Isopropilico.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto22" name="verificacionConcepto22">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto23">23.Pinzas de punta fina.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto23" name="verificacionConcepto23">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto24">24.Paños de microfibra.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto24" name="verificacionConcepto24">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto25">25.Hisopos.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto25" name="verificacionConcepto25">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto26">26.Aire comprimido.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto26" name="verificacionConcepto26">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto27">27.Linterna.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto27" name="verificacionConcepto27">
            </div>
        </div>
    </div>
    ...
    <div class="col-6">
        ...
        <div class="form-group">
            <div class="form-check">
                ...
                <input class="form-check-input" type="checkbox" id="verificacionConcepto6" name="verificacionConcepto6">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto7">7. Número de serie.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto7" name="verificacionConcepto7">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto8">8. Etiqueta de identificación.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto8" name="verificacionConcepto8">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto9">9. Acceso a red Wi-fi.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto9" name="verificacionConcepto9">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto10">10.Acceso en cuenta Outlook.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto10" name="verificacionConcepto10">
            </div>
        </div>
    </div>
    ...
    <div class="col-6">
        ...
        <div class="form-group">
            <div class="form-check">
                ...
                <input class="form-check-input" type="checkbox" id="verificacionConcepto28" name="verificacionConcepto28">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto29">29.Tarjeta madre.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto29" name="verificacionConcepto29">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto30">30.Memoria RAM.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto30" name="verificacionConcepto30">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto31">31.Memoria ROM.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto31" name="verificacionConcepto31">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto32">32.Disco duro.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto32" name="verificacionConcepto32">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto33">33.Tarjeta gráfica.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto33" name="verificacionConcepto33">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto34">34.Tarjeta de sonido.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto34" name="verificacionConcepto34">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto35">35.Bus.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto35" name="verificacionConcepto35">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto36">36.Disipador de calor.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto36" name="verificacionConcepto36">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto37">37.Tarjeta de red.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto37" name="verificacionConcepto37">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto38">38.Memoria caché.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto38" name="verificacionConcepto38">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto39">39.Fuente de poder.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto39" name="verificacionConcepto39">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto40">40.Unidad óptica.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto40" name="verificacionConcepto40">
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-6">
        ...
        <div class="form-group">
            <div class="form-check">
                ...
                <input class="form-check-input" type="checkbox" id="verificacionConcepto11" name="verificacionConcepto11">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto12">12.Puerto HDMI.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto12" name="verificacionConcepto12">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto13">13.Puerto VGA.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto13" name="verificacionConcepto13">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto14">14.Conexión a corriente.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto14" name="verificacionConcepto14">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto15">15.Lector CD.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto15" name="verificacionConcepto15">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto16">16.Puerto SD.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto16" name="verificacionConcepto16">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto17">17.Puerto de audio.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto17" name="verificacionConcepto17">
            </div>
        </div>
    </div>
    ...
    <div class="col-6">
        ...
        <div class="form-group">
            <div class="form-check">
                ...
                <input class="form-check-input" type="checkbox" id="verificacionConcepto41" name="verificacionConcepto41">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto42">42.Tinta de la pantalla.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto42" name="verificacionConcepto42">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto43">43.Cámara.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto43" name="verificacionConcepto43">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto44">44.Rayones en la superficie de la pantalla.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto44" name="verificacionConcepto44">
            </div>
        </div>
    </div>
    ...
    <div class="col-6">
        ...
        <div class="form-group">
            <div class="form-check">
                ...
                <input class="form-check-input" type="checkbox" id="verificacionConcepto18" name="verificacionConcepto18">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto19">19.Pulsera antiestática.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto19" name="verificacionConcepto19">
            </div>
    ...
    <div class="col-6">
        ...
        <div class="form-group">
            <div class="form-check">
                ...
                <input class="form-check-input" type="checkbox" id="verificacionConcepto45" name="verificacionConcepto45">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto46">46.Limpieza de teclado.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto46" name="verificacionConcepto46">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto47">47.Funcionalidad en el panel táctil/TouchPad.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto47" name="verificacionConcepto47">
            </div>
            <div class="form-check">
                <label class="form-check-label" for="verificacionConcepto48">48.Funcionalidad de botones en el teclado.</label>
                <input class="form-check-input" type="checkbox" id="verificacionConcepto48" name="verificacionConcepto48">
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-6">
        <div class="form-group">
            <label for="verificacionConcepto" class="form-label">Concepto</label>
            <textarea class="form-control" id="verificacionConcepto" name="verificacionConcepto" rows="1" placeholder="" required></textarea>
        </div>
    </div>
    <div class="col-6">
        <div class="form-group">
