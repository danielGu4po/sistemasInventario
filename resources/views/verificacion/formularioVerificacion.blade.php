...
.form-check-container:hover label {
    color: #2c3e50; /* Cambia el color del texto cuando se hace hover */
...
.form-check-container:hover .form-check-input {
    ...
    background-color: #2980b9; /* Cambia el color de fondo al pasar el mouse sobre el checkbox */
}
.btn-success {
    padding: 11px 30px; /* Ajusta el relleno del botón */
    font-size: 0.875rem; /* Reduce el tamaño de la fuente */
    width: auto; /* Establece el ancho automático, o puedes especificar un valor en px o % */
}
            </style>
...
<div class="row">
    ...
    <button type="submit" class="btn btn-success btn-small">Aceptar</button>
</div>
        </form>
    </div>
